...
#define STRING_CONFIG_H_AUTHOR "(SKR 1.4 Turbo BLTouch 3.1)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SUPER CHIRON 2.3"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 140 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26, -2, -4 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS + 10), 200 }
